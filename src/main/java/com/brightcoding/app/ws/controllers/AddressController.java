...
public class AddressController {
	...
	public ResponseEntity<List<AddressResponse>> getAllAddresses(Principal principal) {
		...
		List<AddressDto> addressesDto = addressService.getAddressesByUser(principal.getName());
		
		Type listType = new TypeToken<List<AddressResponse>>() {}.getType();
		List<AddressResponse> addressesResponse = new ModelMapper().map(addressesDto, listType);
